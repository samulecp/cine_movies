...
@section('content_header')
    <h1 class="text-sm sm:text-base md:text-lg lg:text-xl">EDITAR DATOS DEL USUARIO</h1>
@stop
...
<div class="responsive-form-container">
    ...
    <form action="/usuario/{{ $usuario->id }}" method="POST" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
