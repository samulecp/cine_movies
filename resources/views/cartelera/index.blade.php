...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <main>
            ...
            <section id="cartelera" class="cartelera-section reveal">
                ...
                <div class="peliculas-container" role="region" aria-label="Galería de películas">
                    <a
    href="{{ route('pelicula.funciones', 1) }}"
    class="pelicula pelicula-featured reveal"
    ...
    <div class="pelicula-overlay">
        Star Wars
                    ...
                    <a
    href="{{ route('pelicula.funciones', 2) }}"
    class="pelicula pelicula-featured reveal"
    style="text-decoration:none;">

    <img src="/img/interstelarposter.jpg"
         alt="Interestelar">
    ...
    <div class="pelicula-overlay">
        Interestelar
                   ...
                   <a
    href="{{ route('pelicula.funciones', 3) }}"
    class="pelicula reveal"
    style="text-decoration:none;">

    <img src="/img/deadpolposter.jpg"
         alt="Deadpool">
    ...
    <div class="pelicula-overlay">
        Deadpool
                    ...
                    <a
    href="{{ route('pelicula.funciones', 4) }}"
    class="pelicula reveal"
    style="text-decoration:none;">

    <img src="/img/sololevelingposter.jpg"
         alt="Solo Leveling">
    ...
    <div class="pelicula-overlay">
        Solo Leveling
                    ...
                    <a
    href="{{ route('pelicula.funciones', 5) }}"
    class="pelicula reveal"
    style="text-decoration:none;">

    <img src="/img/silencioposter.jpg"
         alt="Silencio">
    ...
    <div class="pelicula-overlay">
        Silencio
                    ...
                    <a
    href="{{ route('pelicula.funciones', 6) }}"
    class="pelicula reveal"
    style="text-decoration:none;">
    ...
    <div class="pelicula-overlay">Avatar: Fuego y Ceniza</div>
                    ...
                    <a
    href="{{ route('pelicula.funciones', 7) }}"
    class="pelicula reveal"
    style="text-decoration:none;">

    <img src="/img/ultimoposter.jpg"
         alt="Hasta El Ultimo hombre">
    ...
    <div class="pelicula-overlay">
        Hasta El Ultimo hombre
                    ...
                    <a
    href="{{ route('pelicula.funciones', 8) }}"
    class="pelicula reveal"
    style="text-decoration:none;">

    <img src="/img/serñorposter.jpg"
         alt="El Senor de los anillos">
    ...
    <div class="pelicula-overlay">
        El Senor de los anillos
                    ...
                    <a
    href="{{ route('pelicula.funciones', 9) }}"
    class="pelicula reveal"
    style="text-decoration:none;">

    <img src="/img/ladoposter.jpg"
         alt="El Lado Oscuro">
    ...
    <a
    href="{{ route('pelicula.funciones', 10) }}"
    class="pelicula reveal"
    style="text-decoration:none;">

    <img src="/img/niños2poster.jpg"
         alt="Son como Ninos">
